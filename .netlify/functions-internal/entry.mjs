...
import { A as App, s as server_default, e as deserializeManifest } from './chunks/astro.ddb7b3f8.mjs';
import { _ as _page0, a as _page2 } from './chunks/prerender.4d7d10d6.mjs';
import { _ as _page1 } from './chunks/pages/all.dc9e1615.mjs';
import 'html-escaper';
...
const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/test/api/[cat].astro", _page1],["src/pages/[dog].astro", _page2],]);
const renderers = [Object.assign({"name":"astro:jsx","serverEntrypoint":"astro/jsx/server.js","jsxImportSource":"astro"}, { ssr: server_default }),];

const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/netlify/functions","routes":[{"file":"index.html","links":[],"scripts":[],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"routeData":{"route":"/test/api/[cat]","type":"page","pattern":"^\\/test\\/api\\/([^/]+?)\\/?$","segments":[[{"content":"test","dynamic":false,"spread":false}],[{"content":"api","dynamic":false,"spread":false}],[{"content":"cat","dynamic":true,"spread":false}]],"params":["cat"],"component":"src/pages/test/api/[cat].astro","_meta":{"trailingSlash":"ignore"}}}],"base":"/","markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true,"contentDir":"file:///Users/juanmi/Desktop/astro-beta-2/src/content/"},"pageMap":null,"renderers":[],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"entry.mjs","astro:scripts/before-hydration.js":""},"assets":["/favicon.svg","/index.html"]}), {
	pageMap: pageMap,
	renderers: renderers
});
const _args = {};
